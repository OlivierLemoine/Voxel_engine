                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function astMemberExpression(
                                    ...
                                    if (mNode.computed) {
                                        ...
                                        var unrolled = this.astMemberExpressionUnroll(
                                            mNode
                                        );
                                        if (
                                            mNode.property.type ===
                            ...
                            },
                            {
                                ...
                                value: function astCallExpression(
                                    ...
                                    if (ast.callee) {
                                        var funcName = this.astMemberExpressionUnroll(
                                            ast.callee
                                        );
            ...
            function(require, module, exports) {
                ...
                module.exports = (function(_KernelBase) {
                    ...
                    function CPUKernel(fnString, settings) {
                        ...
                        _this._fnBody = utils.getFunctionBodyFromString(
                            fnString
                        );
                        _this._fn = null;
                        _this.run = null;
                        ...
                        [
                            {
                                ...
                                value: function validateOptions() {
                                    if (
                                        ...
                                        if (argType === 'Array') {
                                            this.output = utils.getDimensions(
                                                argType
                                            );
                            ...
                            },
                            {
                                ...
                                value: function build() {
                                    ...
                                    if (this.graphical) {
                                        ...
                                        this._canvasCtx = canvas.getContext(
                                            '2d'
                                        );
                    ...
                    _createClass(FunctionBuilderBase, [
                        ...
                        },
                        {
                            ...
                            value: function traceFunctionCalls(
                                ...
                                if (fNode) {
                                    var functionIndex = retList.indexOf(
                                        functionName
                                    );
                                    if (functionIndex === -1) {
                    ...
                    function BaseFunctionNode(
                        ...
                        if (paramTypes) {
                            if (Array.isArray(paramTypes)) {
                                ...
                                var paramVariableNames = Object.keys(
                                    paramTypes
                                );
                    ...
                    _createClass(BaseFunctionNode, [
                        ...
                        },
                        {
                            ...
                            value: function getParamType(paramName) {
                                var paramIndex = this.paramNames.indexOf(
                                    paramName
                                );
                        ...
                        },
                        {
                            ...
                            value: function setupParams(args) {
                                ...
                                for (var i = 0; i < args.length; i++) {
                                    var param = args[i];
                                    var paramType = utils.getArgumentType(
                                        param
                                    );
                                ...
                                value: function astFunctionExpression(
                                    ...
                                    if (!funcParam.isRootKernel) {
                                        for (
                                            ...
                                            var type = funcParam.getParamType(
                                                paramName
                                            );
                                            switch (type) {
                                                case 'Texture':
                                    ...
                                    if (mNode.computed) {
                                        if (
                                            ...
                                            if (funcParam.paramNames) {
                                                var idx = funcParam.paramNames.indexOf(
                                                    reqName
                                                );
                                                if (
                                                    idx >= 0 &&
                    ...
                    _createClass(WebGLKernel, [
                        ...
                        },
                        {
                            ...
                            value: function run() {
                                ...
                                if (!this.hardcodeConstants) {
                                    var uOutputDimLoc = this.getUniformLocation(
                                        'uOutputDim'
                                    );
                                    gl.uniform3fv(
                                        uOutputDimLoc,
                                    ...
                                    var uTexSizeLoc = this.getUniformLocation(
                                        'uTexSize'
                                    );
                                ...
                                if (this.subKernelOutputTextures !== null) {
                                    if (this.subKernels !== null) {
                                        var output = [];
                                        output.result = this.renderOutput(
                                            outputTexture
                                        );
                                        for (
                                            var _i = 0;
                        ...
                        },
                        {
                            ...
                            value: function getUniformLocation(name) {
                                var location = this.programUniformLocationCache[
                                    name
                                ];
                                if (!location) {
                        ...
                        },
                        {
                            ...
                            value: function _getFragShaderArtifactMap(args) {
                                return {
                                    ...
                                    MAIN_PARAMS: this._getMainParamsString(
                                        args
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function _addArgument(value, type, name) {
                                var gl = this._webGl;
                                var argumentTexture = this.getArgumentTexture(
                                    name
                                );
                        ...
                        },
                        {
                            ...
                            value: function _addKernels() {
                                ...
                                if (this.subKernels !== null) {
                                    var ext = (this.ext = gl.getExtension(
                                        'WEBGL_draw_buffers'
                                    ));
                                    if (!ext)
                                        throw new Error(
                                    ...
                                    var _ext = (this.ext = gl.getExtension(
                                        'WEBGL_draw_buffers'
                                    ));
                                    if (!_ext)
                                        throw new Error(
            ...
            function(require, module, exports) {
                (function(global, factory) {
                    ...
                    pp$5.enterLexicalScope = function() {
                        var parentScope = this.scopeStack[
                    ...
                    pp$5.canDeclareVarName = function(name) {
                        var currentScope = this.scopeStack[
                            this.scopeStack.length - 1
                        ];
