...
(function e(t, n, r) {
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_FunctionBuilderBase) {
                ...
                function CPUFunctionBuilder() {
                    ...
                    var _this = _possibleConstructorReturn(this, (CPUFunctionBuilder.__proto__ ||
                        Object.getPrototypeOf(CPUFunctionBuilder)).call(this));
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_BaseFunctionNode) {
                ...
                function CPUFunctionNode() {
                    ...
                    return _possibleConstructorReturn(this, (CPUFunctionNode.__proto__ ||
                        Object.getPrototypeOf(CPUFunctionNode)).apply(this, arguments));
                }
                        ...
                        value: function astForStatement(forNode, retArr, funcParam) {
                            ...
                            if (forNode.test &&
                                ...
                                if ((forNode.test.right.type ===
                                    ...
                                    retArr.push(') {\n');
                                    if (forNode.body.type ===
                                        'BlockStatement') {
                                        for (var i = 0; i <
                                            forNode.body.body.length; i++) {
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_KernelBase) {
                ...
                function CPUKernel(fnString, settings) {
                    ...
                    var _this = _possibleConstructorReturn(this, (CPUKernel.__proto__ ||
                        Object.getPrototypeOf(CPUKernel)).call(this, fnString, settings));
                        ...
                        value: function validateOptions() {
                            if (!this.output ||
                                ...
                                if (argType === 'Array') {
                                    ...
                                    throw 'Auto dimensions not supported for input type: ' +
                                        argType;
                                }
                            }
                        }
                    ...
                    },
                    {
                        ...
                        value: function getKernelString() {
                            ...
                            if (this.subKernels !== null) {
                                ...
                                for (var p in this
                                    .subKernelProperties) {
                                    if (!this.subKernelProperties.hasOwnProperty(p))
                                        continue;
                                    var _subKernel = this
                                        .subKernelProperties[p];
                                            ...
                                            : 'return {\n        result: ret,\n        ' +
                                                Object.keys(this.subKernelProperties)
                                                    ...
                                                    return (name +
                                                        ': ' +
                                                        _this2
                                                            .subKernelOutputVariableNames[i]);
                                                })
                                                    .join(',\n') +
                                                '\n      };') +
                                    '\n    ' +
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_RunnerBase) {
                ...
                function CPURunner(settings) {
                    ...
                    var _this = _possibleConstructorReturn(this, (CPURunner.__proto__ ||
                        Object.getPrototypeOf(CPURunner)).call(this, new CPUFunctionBuilder(), settings));
                    ...
                    },
                    {
                        ...
                        value: function addNativeFunctions(nativeFunctions) {
                            for (var functionName in nativeFunctions) {
                                if (!nativeFunctions.hasOwnProperty(functionName))
                                    continue;
                ...
                function BaseFunctionNode(functionName, jsFunction, options, paramTypes, returnType) {
                    ...
                    if (paramTypes) {
                        if (Array.isArray(paramTypes)) {
                            ...
                            if (paramVariableNames.length > 0 &&
                        ...
                        value: function astMemberExpressionUnroll(ast, funcParam) {
                            ...
                            if (ast.type === 'MemberExpression') {
                                if (ast.object && ast.property) {
                                    if (ast.object.hasOwnProperty('name') &&
                                        ast.object.name[0] === '_') {
                            ...
                            if (ast.hasOwnProperty('expressions')) {
                                ...
                                if (firstExpression.type === 'Literal' &&
                    ...
                    },
                    {
                        ...
                        value: function getParamType(paramName) {
                            ...
                            for (var i = 0; i < calledFunctionArguments.length; i++) {
                                ...
                                if (calledFunctionArgument[paramIndex] !==
                                    null) {
                                    return (this.paramTypes[paramIndex] =
                    ...
                    },
                    {
                        ...
                        value: function addSubKernelProperty(property, fnString) {
                            ...
                            if (this.subKernelProperties.hasOwnProperty(property)) {
                                throw new Error('cannot add sub kernel ' +
                                    property +
                                    ', already defined');
                            }
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_FunctionBuilderBase) {
                ...
                function WebGLFunctionBuilder() {
                    ...
                    var _this = _possibleConstructorReturn(this, (WebGLFunctionBuilder.__proto__ ||
                        Object.getPrototypeOf(WebGLFunctionBuilder)).call(this));
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_FunctionNodeBase) {
                ...
                function WebGLFunctionNode() {
                    ...
                    return _possibleConstructorReturn(this, (WebGLFunctionNode.__proto__ ||
                        Object.getPrototypeOf(WebGLFunctionNode)).apply(this, arguments));
                }
                _createClass(WebGLFunctionNode, [
                    {
                        ...
                        value: function generate() {
                            ...
                            if (this.prototypeOnly) {
                                return WebGLFunctionNode.astFunctionPrototype(this.getJsAST(), [], this)
                                    .join('')
                                    .trim();
                            }
                            else {
                        ...
                        value: function astMemberExpression(mNode, retArr, funcParam) {
                            if (mNode.computed) {
                                ...
                                if (unrolled.indexOf(constantsPrefix) === 0) {
                                    unrolled =
                                        'constants_' +
                                            unrolled.slice(constantsPrefix.length);
                                }
                                switch (unrolled_lc) {
                                    case 'this.thread.x':
                                        retArr.push('threadId.x');
                    ...
                    },
                    {
                        key: 'build',
                        value: function build() {
                            return (this.getFunctionPrototypeString()
                                .length > 0);
                        }
                    }
                ], [
            ...
            function ensureIndentifierType(paramName, expectedType, ast, funcParam) {
                ...
                if (!isIdentifierKernelParam(paramName, funcParam) &&
                    expectedType !== 'float') {
                    throw new Error('Error unexpected identifier ' +
                        paramName +
                        ' on line ' +
                        start.line);
                }
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_KernelBase) {
                ...
                function WebGLKernel(fnString, settings) {
                    ...
                    var _this = _possibleConstructorReturn(this, (WebGLKernel.__proto__ ||
                        Object.getPrototypeOf(WebGLKernel)).call(this, fnString, settings));
                    _this.textureCache = {};
                    _this.threadDim = {};
                ...
                _createClass(WebGLKernel, [
                        ...
                        value: function validateOptions() {
                            ...
                            if (!this.output || this.output.length === 0) {
                                ...
                                if (argType === 'Array') {
                                    ...
                                    throw new Error('Auto output not supported for input type: ' +
                                        argType);
                                }
                            }
                    ...
                    },
                    {
                        ...
                        value: function build() {
                            ...
                            if (!buffer) {
                                ...
                                gl.bufferData(gl.ARRAY_BUFFER, vertices.byteLength +
                                    texCoords.byteLength, gl.STATIC_DRAW);
                            }
                            else {
                                gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
                            }
                            ...
                            if (this.subKernelOutputTextures !== null) {
                                ...
                                for (var i = 0; i < this.subKernelOutputTextures.length; i++) {
                                    var subKernelOutputTexture = this
                                        .subKernelOutputTextures[i];
                    ...
                    },
                    {
                        ...
                        value: function renderOutput(outputTexture) {
                            ...
                            if (this.outputToTexture) {
                                ...
                                result = result.subarray(0, threadDim[0] *
                                    threadDim[1] *
                                    threadDim[2]);
                                if (output.length === 1) {
                                    return result;
                    ...
                    },
                    {
                        ...
                        value: function _addArgument(value, type, name) {
                            ...
                            switch (type) {
                                ...
                                default:
                                    throw new Error('Input type not supported (WebGL): ' +
                                        value);
                            }
                    ...
                    },
                    {
                        ...
                        value: function _getConstantsString() {
                            ...
                            var texSize = this.texSize;
                            if (this.hardcodeConstants) {
                                result.push('highp vec3 uOutputDim = vec3(' +
                                    threadDim[0] +
                                    ',' +
                                    threadDim[1] +
                                    ', ' +
                            ...
                            for (var i = 0; i < paramNames.length; i++) {
                                ...
                                if (this.hardcodeConstants) {
                                    if (paramType === 'Array' ||
                                        ...
                                        result.push('uniform highp sampler2D user_' +
                                            paramName, 'highp vec2 user_' +
                                            paramName +
                                            'Size = vec2(' +
                                            paramSize[0] +
                                            '.0, ' +
                                    ...
                                    if (paramType === 'Array' ||
                                        ...
                                        paramType === 'Input') {
                                        result.push('uniform highp sampler2D user_' +
                                            paramName, 'uniform highp vec2 user_' +
                                            paramName +
                                            'Size', 'uniform highp vec3 user_' +
                                            paramName +
                                            'Dim');
                                    }
                                    else if (paramType === 'Number') {
                                        result.push('uniform highp float user_' +
                                            paramName);
                                    }
                                }
                            }
                            ...
                            if (this.constants) {
                                for (var name in this.constants) {
                                    ...
                                    if (Number.isInteger(value)) {
                                        result.push('const float constants_' +
                                            name +
                                            ' = ' +
                                            parseInt(value) +
                                            '.0');
                        ...
                        value: function _getMainResultString() {
                            ...
                            if (this.graphical) {
                                ...
                                for (var i = 0; i < channels.length; ++i) {
                                    ...
                                    result.push('  kernel()');
                                    if (names) {
                                        result.push('  gl_FragData[0].' +
                                            channels[i] +
                                            ' = kernelResult');
                                        for (var j = 0; j < names.length; ++j) {
                                            result.push('  gl_FragData[' +
                                                (j + 1) +
                                                '].' +
                                                channels[i] +
                                                ' = ' +
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_RunnerBase) {
                ...
                function WebGLRunner(settings) {
                    ...
                    var _this = _possibleConstructorReturn(this, (WebGLRunner.__proto__ ||
                        Object.getPrototypeOf(WebGLRunner)).call(this, new WebGLFunctionBuilder(), settings));
        ...
        function (require, module, exports) {
            ...
            module.exports = (function (_WebGLKernel) {
                ...
                function WebGLValidatorKernel() {
                    ...
                    return _possibleConstructorReturn(this, (WebGLValidatorKernel.__proto__ ||
                        Object.getPrototypeOf(WebGLValidatorKernel)).apply(this, arguments));
                }
            ...
            var GPU = (function (_GPUCore) {
                ...
                function GPU(settings) {
                    ...
                    if (!utils.isWebGlSupported()) {
                        if (mode && mode !== 'cpu') {
                            throw new Error('A requested mode of "' +
                                mode +
                ...
                _createClass(GPU, [
                    ...
                    },
                    {
                        ...
                        value: function createKernelMap() {
                            var fn = void 0;
                            var settings = void 0;
                            if (typeof arguments[arguments.length - 2] ===
                                'function') {
                        ...
                        value: function combineKernels() {
                            ...
                            return function () {
                                ...
                                if (lastKernel.output.length === 1) {
                                    ...
                                    var cube = utils.splitArray(result, lastKernel.output[0] *
                                        lastKernel.output[1]);
                                    return cube.map(function (x) {
    ...
    24: [
        function (require, module, exports) {
                ...
                _createClass(UtilsCore, null, [
                    ...
                    },
                    {
                        ...
                        value: function initWebGl(canvasObj) {
                            if (typeof _isCanvasSupported !== 'undefined' ||
                                canvasObj === null) {
                                if (!_isCanvasSupported) {
                                    return null;
                                }
                            ...
                            var webGl = canvasObj.getContext('experimental-webgl', UtilsCore.initWebGlDefaultOptions()) ||
            ...
            var _isCanvasSupported = typeof document !== 'undefined'
        ...
        function (require, module, exports) {
            (function (global, factory) {
                ...
                pp$1.isFunction = function () {
                    return (this.type === types._function ||
                ...
                pp$1.parseFunction = function (node, isStatement, allowExpressionBody, isAsync) {
                    ...
                    return this.finishNode(node, isStatement
                        ? 'FunctionDeclaration'
                        : 'FunctionExpression');
                };
                ...
                pp$1.parseClass = function (node, isStatement) {
                    ...
                    while (!this.eat(types.braceR)) {
                        ...
                        var isAsync = false;
                        var isMaybeStatic = this$1.type === types.name &&
                            this$1.value === 'static';
                        ...
                        if (this$1.options.ecmaVersion >= 8 &&
                            !isGenerator &&
                            !method.computed &&
                ...
                pp$1.adaptDirectivePrologue = function (statements) {
                    for (var i = 0; i < statements.length &&
                        this.isDirectiveCandidate(statements[i]); ++i) {
                    ...
                    switch (expr.type) {
                        case 'Identifier':
                            if (this.strict &&
                                ...
                                this.raiseRecoverable(expr.start, (bindingType
                                    ? 'Binding '
                                    : 'Assigning to ') +
                                    expr.name +
                                    ' in strict mode');
                            ...
                            if (bindingType && bindingType !== 'none') {
                                if ((bindingType === 'var' &&
                                    ...
                                    this.raiseRecoverable(expr.start, "Identifier '" +
                                        expr.name +
                        ...
                        case 'ParenthesizedExpression':
                            ...
                            break;
                        default:
                            this.raise(expr.start, (bindingType ? 'Binding' : 'Assigning to') +
                                ' rvalue');
                    }
                };
                ...
                pp$3.parseExprSubscripts = function (refDestructuringErrors) {
                    ...
                    var skipArrowSubscripts = expr.type === 'ArrowFunctionExpression' &&
                    ...
                    if (refDestructuringErrors &&
                        ...
                        if (refDestructuringErrors.parenthesizedAssign >=
                            result.start) {
                            refDestructuringErrors.parenthesizedAssign = -1;
                        }
                        if (refDestructuringErrors.parenthesizedBind >=
                            result.start) {
                ...
                pp$3.parseSubscripts = function (base, startPos, startLoc, noCalls) {
                    ...
                    for (var computed = void 0;;) {
                        if ((computed = this$1.eat(types.bracketL)) ||
                ...
                pp$3.parseFunctionBody = function (node, isArrowFunction) {
                    ...
                    if (isExpression) {
                        ...
                        this.checkParams(node, !oldStrict &&
                            !useStrict &&
                            !isArrowFunction &&
                            this.isSimpleParamList(node.params));
                ...
                pp$5.canDeclareVarName = function (name) {
                    ...
                    return (!has(currentScope.lexical, name) &&
                ...
                types.braceL.updateContext = function (prevType) {
                    this.context.push(this.braceIsBlock(prevType)
                        ? types$1.b_stat
                        : types$1.b_expr);
                    this.exprAllowed = true;
                };
                ...
                types.parenL.updateContext = function (prevType) {
                    var statementParens = prevType === types._if ||
                        prevType === types._for ||
                ...
                pp$8.readToken = function (code) {
                    if (isIdentifierStart(code, this.options.ecmaVersion >= 6) ||
                        code === 92) {
                ...
                pp$8.skipBlockComment = function () {
                    ...
                    if (this.options.locations) {
                        ...
                        var match;
                        while ((match = lineBreakG.exec(this.input)) &&
                ...
                pp$8.readToken_eq_excl = function (code) {
                    var next = this.input.charCodeAt(this.pos + 1);
                    if (next === 61) {
                        return this.finishOp(types.equality, this.input.charCodeAt(this.pos + 2) === 61
                            ? 3
                            : 2);
                    }
                    if (code === 61 &&
